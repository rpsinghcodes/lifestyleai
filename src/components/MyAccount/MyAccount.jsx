    ...
    return (
        <div className="flex h-full w-full">
            ...
            <div className="p-10 w-full">
                <h1 className="text-3xl font-sqrt-roman text-[#ADADAD]">My Account</h1>
                <hr className="w-full mt-10" />
                <div className="flex  my-[50px] gap-[100px] min-w-[1148px]">
                    <div className="flex-grow ">
                        <h3 className="text-xl font-sqrt-roman">Personal Info</h3>
                        <hr className="w-full mt-5" />
                        <div className="flex justify-between py-[30px] px-20 text-base font-sqrt-roman">
                            <span>Username</span>
                            <span>John Doe</span>
                        ...
                        <hr className="w-full mt-5" />
                        <div className="flex justify-between py-[30px] px-20 text-base items-center font-sqrt-roman">
                            <span>Password</span>
                            <span className="flex">
                        ...
                        <h3 className="text-xl font-sqrt-roman mt-[50px]">Your Subscriptions</h3>
                        <hr className="w-full mt-5" />
                        <div className="flex flex-col gap-4 py-[30px] px-20 text-base font-sqrt-roman">
                        ...
                        {/* Payment Method */}
                        <h3 className="text-xl font-sqrt-roman mt-[50px]">Payment Method</h3>
                        <hr className="w-full mt-5" />
                        <div className="flex justify-around items-center py-[30px] pl-20 text-base font-sqrt-roman">
                        ...
                        <button className="rounded-full border-[2px] px-4 py-2 mt-5 text-base font-sqrt">Add Payment Method</button>

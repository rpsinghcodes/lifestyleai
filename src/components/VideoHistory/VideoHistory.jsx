...
This component display video history that user clicks on
*/
...
export default function VideoHistory() {
    return (
        ...
        <div className="p-10 w-full">
            <h1 className="text-3xl laptopSmall:text-xl font-sqrt-roman text-[#ADADAD]">History Videos</h1>
            <hr className="w-full mt-10" />
            <section className="flex justify-between font-sqrt-roman my-[50px]">
                <div className="text-xl laptopSmall:text-base ">
                    <div>
                        {/* Today Section */}
                    <div >

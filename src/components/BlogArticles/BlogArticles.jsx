...
const history = {
    today:[
        {img:"/images/h20.png", title:"H20.ai", channel:"", views:"", date:""},
        {img:"/images/pyTorch.png", title:"PyTorch", channel:"", views:"", date:""},
        {img:"/images/rapidMiner.png", title:"RapidMiner", channel:"", views:"", date:""},
        {img:"/images/mlFlow.png", title:"MLFlow", channel:"", views:"", date:""},
    ]
}
...
export default function BlogArticles(){
    return(
        ...
        <div className="p-10 w-full">
            <h1 className="text-5xl font-sqrt-roman text-[#ADADAD]">Video History</h1>

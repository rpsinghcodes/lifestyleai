                ...
                <button className={`${listClass}  ${(section === "bookmark-tools" || section === "bookmark-history" || section === "bookmark-blog-and-articles") && "bg-[#116466]"} relative`} onClick={() => setBookMarkIsOpen(!bookmarkIsOpen)}>Bookmarks</button>
                    {bookmarkIsOpen && (
                        <div className="absolute bg-[#116466] top-16 flex flex-col gap-3  rounded p-2 z-10">
                            <span className="text-[20px] border-b rounded p-1 hover:bg-slate-200" onClick={() => {updateSection("bookmark-tools"); setBookMarkIsOpen(!bookmarkIsOpen)}}>Bookmarked Tools</span>
                            <span className="text-[20px] border-b rounded p-1 hover:bg-slate-200"onClick={() => {updateSection("bookmark-history"); setBookMarkIsOpen(!bookmarkIsOpen)}}>Bookmarked Videos</span>
                ...
                <button className={`${listClass} relative ${(section === "tool-history" || section === "videos-history" || section === "history-blog-and-articles") && "bg-[#116466]"}`} onClick={() => setHistoryIsOpen(!historyIsOpen)}>History</button>
                    {historyIsOpen && (
                        <div className="absolute bg-[#116466] top-16 flex flex-col gap-3  rounded p-2 z-10">
                            ...
                            <span className="text-[20px] border-b rounded p-1 hover:bg-slate-200" onClick={() => {updateSection("videos-history"); setHistoryIsOpen(!historyIsOpen)}}>Video History</span>
